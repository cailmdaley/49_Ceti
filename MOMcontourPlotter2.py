...
colors = [(255,255,255),(240,255,255),(210,253,255),(184,252,255),(192,244,204),(155,255,145),(210,200,12),(230,180,7),(236,124,13),(233,100,25),(230,60,30),(228,30,45),(227,7,63),(222,5,150),(218,2,218)]# FINAL!
...
def plotcmd(dat,ax,levs1):
	...
	if ax.is_first_col():
		...
		for tick in ax.yaxis.get_major_ticks():
			tick.label.set_fontsize(8)
		line = pylab.Line2D((818,988.666),(50,50),lw=1,color='k') ##100AU scale bar
		ax.add_line(line)
		line = pylab.Line2D((818,818),(45,55),lw=1,color='k')
		ax.add_line(line)
		line = pylab.Line2D((988.666,988.666),(45,55),lw=1,color='k')
		ax.add_line(line)
		ax.text(50,967,'robust=2',fontsize=8,path_effects=[PathEffects.withStroke(linewidth=2,foreground="w")])
		ax.text(830,65,'100 AU',fontsize=8,path_effects=[PathEffects.withStroke(linewidth=2,foreground="w")])
		ax.text(453,967,'49 Ceti',fontsize=8,path_effects=[PathEffects.withStroke(linewidth=2,foreground="w")])#color='k')
		ax.text(311,920,'ALMA CO(3-2) Moment 0',fontsize=8,path_effects=[PathEffects.withStroke(linewidth=2,foreground="w")])
		ax.text(444,1053,'mJy/bm',fontsize=8,path_effects=[PathEffects.withStroke(linewidth=2,foreground="w")])
